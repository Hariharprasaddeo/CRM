...
public class ExcelHelperService {
    ...
    static String[] HEADERs = { "Lead Id", "First Name", "Last Name", "Email", "Mobile", "Address", "Company", "Designation", "Lead Type", "Note" };
    ...
    public static ByteArrayInputStream leadsToExcel(List<Lead> leads) {
        ...
        try (
            ...
            for (Lead lead : leads) {
                ...
                row.createCell(6).setCellValue(lead.getCompany());
